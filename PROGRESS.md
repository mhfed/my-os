...
|---|---|---|
| Global Capture Button | P0 | ⚠️ Ô capture ở Today (chưa phải nút nổi trên *mọi* màn) |
...
| Thêm habit | ⚠️ qua `addHabit` (triage tạo được) — chưa có form riêng trên màn Habits |
